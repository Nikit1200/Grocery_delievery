    ...
    return (
        <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-24 bg-primary/10">
            <div className="flex flex-col items-start justify-between gap-10 border-b border-gray-500/30 py-10 text-gray-500 md:flex-row">
                <div>
                    ...
                    <p className="mt-6 max-w-[410px]">
                       we deliver the best groceries and  snacks straight to your door.Trusted by thousands, we aim to make your shopping experience simple and affordable.
                    </p>
                </div>
            ...
            <p className="py-4 text-center text-sm  md:text-base">
                Copyright {new Date().getFullYear()} &copy; <a href="https://prebuiltui.com">PrebuiltUI</a> All Right Reserved.
            </p>
        </div>
    )
}
